...
## Crippling Roots
execute as @s[scores={rw2a.SecondaryDuration=1..}] run function rw2a:races/trent/ability_crippling_roots
scoreboard players set @s[scores={rw2a.SecondaryAuxiliaryCooldown=200..}] rw2a.SecondaryAuxiliaryCooldown 0
scoreboard players set @s[scores={rw2a.SecondaryDuration=1200..}] rw2a.SecondaryDuration 0
scoreboard players set @s[scores={rw2a.SecondaryDuration=1200..}] rw2a.SecondaryAuxiliaryCooldown 0
