...
execute store result score @s ...Armor run attribute @s generic.armor get 10
...
execute as @s[tag=__mob] run function rw2a:__/fx/_s/-entity/-piloted/-records/update/attributes/copy2marker/_0